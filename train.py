...
config = SimpleNamespace(    
    ...
    model_ckpt = "models/DDPM_unconditional_2/ckpt_2.pt", # load from pretrained
    ema_model_ckpt = "models/DDPM_unconditional_2/ema_ckpt_2.pt", # load from pretrained
    device = "cuda",
    do_validation = True,
    fp16 = True,
    log_every_epoch = 1,
